...
unsigned int nStakeTargetSpacing = 20; // 20 seconds spacing
...
const string strMessageMagic = "NLEXIT Signed Message:\n";
...
{
    static const int nMinSubsidy = 0.01 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NLEXIT
...
bool CBlock::AcceptBlock()
{
    ...
    static const int nMaxOffset = 7 * nOneWeek;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NLEXIT", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Time to NLEXIT";
        CTransaction txNew;
        txNew.nTime = 1481929424;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1481929424;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1074307;
		if(fTestNet)
        {
            block.nNonce   = 4901;
        }
        ...
        //// debug print        
        block.print();
        assert(block.hashMerkleRoot == uint256("0xb9f25c725cc5b1de7aaaa1440f9a745f3af126192f9e12426ee85d325c00c47b"));
...
unsigned char pchMessageStart[4] = { 0xa6, 0xa9, 0xf0, 0x08 };
