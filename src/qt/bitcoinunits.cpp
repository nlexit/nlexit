...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("NLEXIT");
    case mBTC: return QString("mNLEXIT");
    case uBTC: return QString::fromUtf8("μNLEXIT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("NLEXITs"));
    case mBTC: return QString(QObject::tr("Milli-NLEXITs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-NLEXITs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
