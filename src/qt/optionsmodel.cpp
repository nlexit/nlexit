...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/nlexit/tx/%s|https://coinplorer.com/NLEXIT/Transactions/%s|https://explorer.novaco.in/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/nlexit/tx/%s|https://coinplorer.com/NLEXIT/Transactions/%s|https://explorer.novaco.in/tx/%s").toString();
