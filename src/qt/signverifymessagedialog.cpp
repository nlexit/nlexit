    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a NLEXIT address (e.g. NbLgkaBmTuoTivW9HVJT7XS2NmswZVhqiQ)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a NLEXIT address (e.g. NbLgkaBmTuoTivW9HVJT7XS2NmswZVhqiQ)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter NLEXIT signature"));
#endif
