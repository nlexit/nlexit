...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (      0, std::make_pair(hashGenesisBlock, 1481929424) )
        (      3, std::make_pair(uint256("0x00000f749183a6204ff60d3ff1ea933f19313a54b797837938d0bf1ca4d556f2"), 1481979323) )
    ;

    // TestNet has no checkpoints
    static MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, std::make_pair(hashGenesisBlockTestNet, 1476396280) )
        ;
